...
Route::middleware('auth')->group(function () {
    ...
    // Teleconsultation Route (Accessible by Patient & Doctor)
    Route::get('/teleconsultation/{id}', [\App\Http\Controllers\TeleconsultationController::class, 'join'])->name('teleconsultation.join');
});
