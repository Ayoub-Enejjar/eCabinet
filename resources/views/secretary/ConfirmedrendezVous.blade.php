...
@section('title', 'Secretary - Confirmed Appointments')
...
<div class="max-w-7xl mx-auto space-y-8">
    ...
    <div class="flex items-end justify-between gap-4 mb-4">
        <div>
            <h2 class="text-3xl font-extrabold font-headline tracking-tight text-on-surface mb-1">Confirmed Appointments</h2>
            <p class="text-on-surface-variant font-body">Database of confirmed appointments.</p>
        </div>
        <div class="flex items-center gap-3">
            <span class="text-sm font-bold bg-primary-container text-on-primary-container px-3 py-1 rounded-full">{{ $rendezVous->total() }} confirmed</span>
        </div>
    </div>
    ...
    <section class="space-y-6">
        <div class="bg-surface-container-lowest rounded-xl overflow-hidden shadow-[0_10px_30px_-5px_rgba(0,106,97,0.08)] border border-outline-variant/10">
            @if($rendezVous->count() == 0)
                <div class="p-10 text-center text-on-surface-variant font-medium">No confirmed appointments found.</div>
            @else
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-outline-variant/10">
                        ...
                        <tr class="hover:bg-surface-container-low/50 transition-colors group">
                            ...
                            <td class="px-8 py-4 text-center">
                                <span class="px-3 py-1 text-[10px] font-bold rounded-full uppercase tracking-wider bg-primary-container text-on-primary-container">
                                    {{ $rv->statut }}
                                </span>
                            </td>
                        </tr>
